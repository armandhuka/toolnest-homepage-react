...
const WeightConverter = () => {
  ...
  useEffect(() => {
    document.title = 'Weight Converter - ToolNest';
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Convert between different weight units like kilograms, pounds, grams, ounces with this free online weight converter tool.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Convert between different weight units like kilograms, pounds, grams, ounces with this free online weight converter tool.';
